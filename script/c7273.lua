...
function c7273.initial_effect(c)
	...
	e1:SetTarget(c7273.target)
	e1:SetOperation(c7273.operation)
	c:RegisterEffect(e1)
	--disable
...
function c7273.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c7273.operation(e,tp,eg,ep,ev,re,r,rp)
...
function c7273.distg(e,c)
	return e:GetHandler():IsHasCardTarget(c)
end
function c7273.actcon(e)
