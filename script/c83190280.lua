...
function c83190280.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(83190280,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_PZONE)
	e2:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e2:SetCountLimit(1)
	e2:SetTarget(c83190280.tg1)
	e2:SetOperation(c83190280.op1)
	c:RegisterEffect(e2)
	--spsummon
	...
	e3:SetCountLimit(1,83190280)
	e3:SetCondition(c83190280.spcon2)
	e3:SetTarget(c83190280.sptg2)
	e3:SetOperation(c83190280.spop2)
	c:RegisterEffect(e3)
end
...
function c83190280.tg1(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c83190280.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and Duel.SpecialSummonStep(tc,0,tp,tp,false,false,POS_FACEUP) then
		...
		e3:SetCountLimit(1)
		e3:SetOperation(c83190280.rmop1)
...
function c83190280.rmop1(e,tp,eg,ep,ev,re,r,rp)
