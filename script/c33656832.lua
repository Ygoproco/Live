...
function c33656832.initial_effect(c)
	...
	e1:SetCondition(c33656832.spcon1)
	e1:SetTarget(c33656832.sptg)
	e1:SetOperation(c33656832.spop1)
	c:RegisterEffect(e1)
	--Special Summon (hand)
	...
	e2:SetOperation(c33656832.spop1)
	c:RegisterEffect(e2)
	--Place
	...
	e7:SetTarget(c33656832.pentg)
	e7:SetOperation(c33656832.penop)
	c:RegisterEffect(e7)
end

function c33656832.spcfil1(c,tp)
	return c:IsPreviousLocation(LOCATION_MZONE) and c:GetPreviousControler()==tp and c:IsReason(REASON_EFFECT)
end
function c33656832.spcon1(e,tp,eg,ep,ev,re,r,rp)
	return eg:IsExists(c33656832.spcfil1,1,nil,tp)
end
