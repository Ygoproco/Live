...
function c19302550.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(19302550,2))
	...
	e3:SetTarget(c19302550.distg)
	e3:SetOperation(c19302550.disop)
	c:RegisterEffect(e3)
	--tohand
...
function c19302550.distg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(19302550)==0 end
end
function c19302550.disop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SelectYesNo(tp,aux.Stringid(19302550,0)) then
		c:RegisterFlagEffect(19302550,RESET_EVENT+0x1fe0000,0,1)
...
function c19302550.thfilter(c)
	return (c:IsSetCard(0xae) or c:IsSetCard(0xaf)) and not c:IsCode(19302550) and c:IsAbleToHand()
end
