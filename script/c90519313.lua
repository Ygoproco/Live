...
function c90519313.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetTarget(c90519313.target)
	e2:SetOperation(c90519313.operation)
	c:RegisterEffect(e2)
end

function c90519313.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c90519313.operation(e,tp,eg,ep,ev,re,r,rp)
