...
function c18563744.initial_effect(c)
  ...
  e1:SetTarget(c18563744.tg)
  e1:SetOperation(c18563744.op)
  c:RegisterEffect(e1)
...
function c18563744.fil(c)
  return c:IsFaceup() and c:IsSetCard(0xe7)
end
function c18563744.tg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
  if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c18563744.fil(chkc) end
  if chk==0 then return Duel.IsExistingTarget(c18563744.fil,tp,LOCATION_MZONE,0,1,nil) end
  Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
  Duel.SelectTarget(tp,c18563744.fil,tp,LOCATION_MZONE,0,1,1,nil)
end
function c18563744.op(e,tp,eg,ep,ev,re,r,rp)
  local c=e:GetHandler()
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() then
	  ...
	  local e5=Effect.CreateEffect(c)
		...
		e5:SetValue(c18563744.efilter)
		e5:SetReset(RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END)
		tc:RegisterEffect(e5)
	end
end
function c18563744.efilter(e,te)
