...
function c55063751.initial_effect(c)
	...
	e3:SetCondition(c55063751.ngcon)
	e3:SetCost(c55063751.ngcost)
	e3:SetTarget(c55063751.ngtg)
	e3:SetOperation(c55063751.ngop)
	c:RegisterEffect(e3)
end
...
function c55063751.ngcon(e,tp,eg,ep,ev,re,r,rp)
	return rp~=tp and re:GetHandler():GetCode()~=55063751 and Duel.IsChainNegatable(ev)
end
function c55063751.ngcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsCanRemoveCounter(tp,1,1,0x37,2,REASON_COST) end
	Duel.RemoveCounter(tp,1,1,0x37,2,REASON_COST)
end
function c55063751.ngtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c55063751.ngop(e,tp,eg,ep,ev,re,r,rp)
