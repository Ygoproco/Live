...
function c56907986.initial_effect(c)
	...
	e1:SetCost(c56907986.spcost)
	e1:SetTarget(c56907986.sptg)
	e1:SetOperation(c56907986.spop)
	c:RegisterEffect(e1)
	...
	e2:SetCountLimit(1)
	e2:SetCost(c56907986.cost)
	e2:SetTarget(c56907986.target)
	e2:SetOperation(c56907986.activate)
	c:RegisterEffect(e2)
end
...
function c56907986.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c56907986.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c56907986.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c56907986.activate(e,tp,eg,ep,ev,re,r,rp)
	if Duel.GetLocationCount(tp,LOCATION_MZONE)<=0 then return end
