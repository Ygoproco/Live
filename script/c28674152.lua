...
function c28674152.initial_effect(c)
	...
	e4:SetCountLimit(1)
	e4:SetCost(c28674152.tkcost)
	e4:SetTarget(c28674152.tktg)
	e4:SetOperation(c28674152.tkop)
	c:RegisterEffect(e4)
end
...
function c28674152.tkop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.IsPlayerCanSpecialSummonMonster(tp,28674153,0,0x4011,2800,0,7,RACE_FIEND,ATTRIBUTE_DARK) then
