...
function c28674152.spcon(e,c)
	...
	return Duel.GetLocationCount(1-tp,LOCATION_MZONE)>-1
		...
		and not Duel.IsExistingMatchingCard(c28674152.cfilter,tp,0,LOCATION_MZONE,1,nil)
end
...
function c28674152.spcon2(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and not Duel.IsExistingMatchingCard(c28674152.cfilter,tp,LOCATION_MZONE,0,1,nil)
end
