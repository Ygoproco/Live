...
function c20137754.initial_effect(c)
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c20137754.condition)
	e3:SetTarget(c20137754.target)
	e3:SetOperation(c20137754.operation)
	c:RegisterEffect(e3)
...
function c20137754.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentPhase()~=PHASE_DAMAGE or not Duel.IsDamageCalculated()
end
function c20137754.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():GetFlagEffect(20137754)>0 end
end
function c20137754.operation(e,tp,eg,ep,ev,re,r,rp)
