...
function c36426778.spfil(c)
	return c:IsFaceup() and c:IsSetCard(0x10df)
end
function c36426778.spcon(e,c)
	if c==nil then return true end
	local tp=c:GetControler()
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(c36426778.spfil,tp,LOCATION_MZONE,0,1,nil)
end
