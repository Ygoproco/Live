...
function c7025.rmtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local g1=Duel.SelectTarget(tp,c7025.rmfilter,tp,LOCATION_REMOVED,0,1,1,nil,e,tp,91998119)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g2=Duel.SelectTarget(tp,c7025.rmfilter,tp,LOCATION_REMOVED,0,1,1,nil,e,tp,7024)
	g1:Merge(g2)
