...
function c33460840.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(33460840,0))
	...
	e4:SetDescription(aux.Stringid(33460840,1))
...
function c33460840.eqtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_SZONE)>0
		and Duel.IsExistingMatchingCard(c33460840.eqfil,tp,LOCATION_GRAVE+LOCATION_HAND,0,1,nil,e:GetHandler()) end
...
function c33460840.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.Hint(HINT_SELECTMSG,tp,aux.Stringid(33460840,0))
	local g=Duel.SelectMatchingCard(tp,c33460840.eqfil,tp,LOCATION_GRAVE+LOCATION_HAND,0,1,1,nil,c)
	local tc=g:GetFirst()
