...
function c48770333.initial_effect(c)
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c48770333.con)
	e3:SetCost(c48770333.cost)
	e3:SetOperation(c48770333.op)
	c:RegisterEffect(e3)
end
...
function c48770333.spcon(e,c)
	...
	return Duel.GetLocationCount(1-tp,LOCATION_MZONE)>-1
		...
		and not Duel.IsExistingMatchingCard(c48770333.cfilter,tp,0,LOCATION_MZONE,1,nil)
end
...
function c48770333.spcon2(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		...
		and not Duel.IsExistingMatchingCard(c48770333.cfilter,tp,LOCATION_MZONE,0,1,nil)
end

function c48770333.con(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsAbleToEnterBP()
end
function c48770333.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsCanRemoveCounter(tp,1,1,0x37,3,REASON_COST) end
	Duel.RemoveCounter(tp,1,1,0x37,3,REASON_COST)
end
function c48770333.op(e,tp,eg,ep,ev,re,r,rp)
	...
	e5:SetCondition(c48770333.dircon)
	e5:SetReset(RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END)
	c:RegisterEffect(e5)
	local e6=e5:Clone()
	e6:SetCode(EFFECT_CANNOT_ATTACK)
	e6:SetCondition(c48770333.atkcon2)
	c:RegisterEffect(e6)
end
