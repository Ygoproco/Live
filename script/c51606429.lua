...
function c51606429.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(51606429,0))
	...
	e2:SetDescription(aux.Stringid(51606429,1))
...
function c51606429.negfil(c)
	return aux.disfilter1(c) and c:IsType(TYPE_TRAP)
end
function c51606429.negtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsControler(1-tp) and chkc:IsOnField() and c51606429.negfil(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c51606429.negfil,tp,0,LOCATION_ONFIELD,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
	local g=Duel.SelectTarget(tp,c51606429.negfil,tp,0,LOCATION_ONFIELD,1,1,nil)
