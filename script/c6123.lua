...
function c6123.spcon(e,tp,eg,ep,ev,re,r,rp)
...
function c6123.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingTarget(c6123.spfil,tp,LOCATION_GRAVE,0,1,nil,e,tp,turn) end
