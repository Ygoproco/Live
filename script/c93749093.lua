...
function c93749093.spfil(c,e,tp)
...
function c93749093.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and Duel.IsExistingMatchingCard(c93749093.spfil,tp,LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE,0,1,e:GetHandler(),e,tp) end
...
function c93749093.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c93749093.spfil,tp,LOCATION_HAND+LOCATION_DECK+LOCATION_GRAVE,0,1,lc,e:GetHandler(),e,tp)
