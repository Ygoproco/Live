...
function c93124273.initial_effect(c)
	...
	e1:SetTarget(c93124273.destg)
	e1:SetOperation(c93124273.desop)
	c:RegisterEffect(e1)
end

function c93124273.destg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c93124273.desop(e,tp,eg,ep,ev,re,r,rp)
