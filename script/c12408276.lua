...
function c12408276.initial_effect(c)
  --spsummon
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c12408276.discon)
	e2:SetCost(c12408276.discost)
	e2:SetTarget(c12408276.distg)
	e2:SetOperation(c12408276.disop)
	c:RegisterEffect(e2)
end
...
function c12408276.discon(e,tp,eg,ep,ev,re,r,rp)
	return re:GetHandler()~=e:GetHandler() and not e:GetHandler():IsStatus(STATUS_BATTLE_DESTROYED)
		and re:IsActiveType(TYPE_MONSTER) and Duel.IsChainNegatable(ev)
end
function c12408276.discost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLPCost(tp,1000) end
	Duel.PayLPCost(tp,1000)
end
function c12408276.distg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c12408276.disop(e,tp,eg,ep,ev,re,r,rp)
