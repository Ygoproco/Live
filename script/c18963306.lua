...
function c18963306.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	e1:SetTarget(c18963306.ftarget)
  ...
  local c=e:GetHandler()
	...
	if tc:IsRelateToEffect(e) then
	  ...
	  if Duel.GetControl(tc,tp,PHASE_END,1) then
		...
		tc:RegisterFlagEffect(18963306,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,0,1)
...
function c18963306.nccon(e)
	return e:GetHandler():GetFlagEffect(18963306)==0
end
function c18963306.ftarget(e,c)
