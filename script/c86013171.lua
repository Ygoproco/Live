...
function c86013171.initial_effect(c)
  local e1=Effect.CreateEffect(c)
	...
	e2:SetCost(c86013171.tgcost)
	e2:SetTarget(c86013171.tgtg)
	e2:SetOperation(c86013171.tgop)
	c:RegisterEffect(e2)
end
...
function c86013171.tgcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c86013171.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
  ...
  if chk==0 then return Duel.IsExistingTarget(c86013171.tgfil,tp,LOCATION_REMOVED,0,3,nil) end
  Duel.Hint(HINT_SELECTMSG,tp,aux.Stringid(86013171,2))
	local g=Duel.SelectTarget(tp,c86013171.tgfil,tp,LOCATION_REMOVED,0,3,3,nil)
	Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,g,3,0,0)
	Duel.SetOperationInfo(0,CATEGORY_DAMAGE,nil,0,1-tp,500)
end
function c86013171.tgop(e,tp,eg,ep,ev,re,r,rp)
