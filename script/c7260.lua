...
function c7260.initial_effect(c)
  ...
  e1:SetDescription(aux.Stringid(7260,0))
  e1:SetCategory(CATEGORY_CONTROL+CATEGORY_DESTROY)
  e1:SetType(EFFECT_TYPE_IGNITION)
  e1:SetRange(LOCATION_MZONE)
  e1:SetCountLimit(1)
  e1:SetTarget(c7260.target)
  e1:SetOperation(c7260.operation)
  c:RegisterEffect(e1)
end

function c7260.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c7260.operation(e,tp,eg,ep,ev,re,r,rp)
