...
function c77462146.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return not e:GetHandler():IsStatus(STATUS_CHAINING) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,77462146,0x10df,0x11,4,0,300,RACE_WARRIOR,ATTRIBUTE_DARK) end
...
function c77462146.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e)
		and Duel.IsPlayerCanSpecialSummonMonster(tp,77462146,0x10df,0x11,4,0,300,RACE_WARRIOR,ATTRIBUTE_DARK) then
