...
function c82321037.rmfilter(c,tp)
...
function c82321037.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Destroy(g1,REASON_EFFECT)==2 then
		...
		local g=Duel.GetMatchingGroup(c82321037.rmfilter,tp,0,LOCATION_ONFIELD+LOCATION_GRAVE,nil,tp)
		if g1:FilterCount(Card.IsAttribute,nil,ATTRIBUTE_WATER)==2 and g:GetCount()>0
			...
			local g=Duel.SelectMatchingCard(tp,c82321037.rmfilter,tp,0,LOCATION_ONFIELD+LOCATION_GRAVE,1,2,nil,tp)
