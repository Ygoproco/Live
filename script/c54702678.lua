...
function c54702678.discon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler()==Duel.GetAttacker() and e:GetHandler():IsStatus(STATUS_OPPO_BATTLE)
end
...
function c54702678.damcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:IsRelateToBattle() and c:GetBattleTarget():IsType(TYPE_MONSTER) and c:IsSatus(STATUS_OPPO_BATTLE)
end
