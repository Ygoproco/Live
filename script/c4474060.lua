...
function c4474060.initial_effect(c)
	...
	e1:SetTarget(c4474060.sdtg)
	e1:SetOperation(c4474060.sdop)
	c:RegisterEffect(e1)
	local e2=e1:Clone()
...
function c4474060.sdtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetFieldGroupCount(tp,0,LOCATION_DECK)>2 end
end
function c4474060.sdop(e,tp,eg,ep,ev,re,r,rp)
...
function c4474060.atktg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsControler(tp) and c4474060.atkfil(chkc) end
	if chk==0 then return Duel.IsExistingTarget(c4474060.atkfil,tp,LOCATION_MZONE,0,1,e:GetHandler()) and mc>0 end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
	Duel.SelectTarget(tp,c4474060.atkfil,tp,LOCATION_MZONE,0,1,1,e:GetHandler())
end
