...
function c57354389.initial_effect(c)
  ...
  local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(57354389,0))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_IGNITION)
	e2:SetRange(LOCATION_GRAVE)
	e2:SetCountLimit(1,57354389)
	e2:SetCondition(c57354389.spcon)
	e2:SetTarget(c57354389.sptg)
	e2:SetOperation(c57354389.spop)
	c:RegisterEffect(e2)
end
