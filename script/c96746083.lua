...
function c96746083.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc1:IsLocation(LOCATION_HAND) and ft<1 then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
		g2=Duel.SelectMatchingCard(tp,c96746083.desfilter,tp,LOCATION_MZONE,0,1,1,tc1,c)
	else
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_DESTROY)
		g2=Duel.SelectMatchingCard(tp,c96746083.desfilter,tp,LOCATION_MZONE+LOCATION_HAND,0,1,1,tc1,c)
	end
