...
function c7190.initial_effect(c)
	--Activate
	...
	e1:SetCountLimit(1,7190)
	e1:SetTarget(c7190.target)
	e1:SetOperation(c7190.operation)
	c:RegisterEffect(e1)
	--
...
function c7190.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingTarget(c7190.spfilter,tp,LOCATION_GRAVE,0,1,nil,e,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectTarget(tp,c7190.spfilter,tp,LOCATION_GRAVE,0,1,1,nil,e,tp)
