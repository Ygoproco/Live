...
function c93302695.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetCost(c93302695.incost)
	e2:SetOperation(c93302695.inop)
	c:RegisterEffect(e2)
end
...
function c93302695.incost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLPCost(tp,1000) end
	Duel.PayLPCost(tp,1000)
end
function c93302695.inop(e,tp,eg,ep,ev,re,r,rp)
