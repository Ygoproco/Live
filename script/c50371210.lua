...
function c50371210.initial_effect(c)
	...
	e0:SetOperation(c50371210.rmop)
	c:RegisterEffect(e0)
end
...
function c50371210.condition(e,tp,eg,ep,ev,re,r,rp)
	return not Duel.IsExistingMatchingCard(c50371210.cfil1,tp,LOCATION_ONFIELD,0,1,nil) and Duel.GetMatchingGroupCount(Card.IsSetCard,tp,LOCATION_GRAVE,0,nil,0xdd)>=3
end
