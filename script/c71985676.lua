...
function c71985676.spcfil(c)
  return c:IsSetCard(0x9f) and c:IsDiscardable()
end
function c71985676.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c71985676.spcfil,tp,LOCATION_HAND,0,1,nil) end
	Duel.DiscardHand(tp,c71985676.spcfil,1,1,REASON_COST+REASON_DISCARD)
end
