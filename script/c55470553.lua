...
function c55470553.initial_effect(c)
	...
	e1:SetCost(c55470553.atkcost)
	e1:SetTarget(c55470553.atktg)
	e1:SetOperation(c55470553.atkop)
	c:RegisterEffect(e1)
	--Special Summon
...
function c55470553.atkcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c55470553.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and c55470553.spfil(chkc,tp) end
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENCE) and Duel.IsExistingTarget(c55470553.spfil,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil,tp) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TARGET)
	Duel.SelectTarget(tp,c55470553.spfil,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil,tp)
