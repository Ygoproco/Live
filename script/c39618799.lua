...
function c39618799.thfil(c)
  return c:IsAbleToHand() and (c:IsCode(39996157) or bit.band(c:GetType(),0x81)==0x81)
end
function c39618799.thtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
  if chkc then return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c39618799.thfil(chkc) end
  if chk==0 then return Duel.IsExistingTarget(c39618799.thfil,tp,LOCATION_GRAVE,0,1,nil) end
  Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
  local g=Duel.SelectTarget(tp,c39618799.thfil,tp,LOCATION_GRAVE,0,1,1,nil)
