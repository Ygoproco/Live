...
function c16516630.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetValue(1)
	e1:SetCondition(c16516630.descon)
	...
	e3:SetCondition(c16516630.descon)
	e3:SetOperation(c16516630.desop)
	e3:SetReset(RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END)
	tc:RegisterEffect(e3)
end
function c16516630.descon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsStatus(STATUS_OPPO_BATTLE)
end
