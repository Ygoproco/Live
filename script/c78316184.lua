...
function c78316184.initial_effect(c)
	...
	e2:SetCountLimit(1)
	e2:SetCondition(c78316184.condition)
	e2:SetCost(c78316184.cost)
	e2:SetTarget(c78316184.target)
	e2:SetOperation(c78316184.operation)
	c:RegisterEffect(e2)
end
...
function c78316184.destg(e,tp,eg,ep,ev,re,r,rp,chk)
	local g=Duel.GetMatchingGroup(c78316184.desfil,tp,0,LOCATION_MZONE,nil)
...
function c78316184.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c78316184.cfilter(c)
	return c:IsType(TYPE_MONSTER) and c:IsType(TYPE_RITUAL) and c:IsAbleToDeckAsCost()
end
function c78316184.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c78316184.cfilter,tp,LOCATION_GRAVE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TODECK)
	local g=Duel.SelectMatchingCard(tp,c78316184.cfilter,tp,LOCATION_GRAVE,0,1,1,nil)
	Duel.SendtoDeck(g,nil,2,REASON_COST)
end
function c78316184.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c78316184.operation(e,tp,eg,ep,ev,re,r,rp)
